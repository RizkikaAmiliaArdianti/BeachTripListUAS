...
public class MainActivity extends AppCompatActivity {
    ...
    private void inisialisasiView() {
        ...
        btnLotim.setOnClickListener(view -> bukaGaleri(getString(R.string.lombok_timur)));
        btnLoteng.setOnClickListener(view -> bukaGaleri(getString(R.string.lombok_tengah)));
        btnKlu.setOnClickListener(view -> bukaGaleri(getString(R.string.lombok_utara)));
    }
